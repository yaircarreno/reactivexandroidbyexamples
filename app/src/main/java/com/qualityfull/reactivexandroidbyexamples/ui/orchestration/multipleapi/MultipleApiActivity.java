...
public class MultipleApiActivity extends BaseActivity implements MultipleApiMvpView {

    @Inject
    MultipleApiPresenter multipleApiPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiple_api);
        ButterKnife.bind(this);

        multipleApiPresenter.attachView(this);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        multipleApiPresenter.detachView();
    }

    @OnClick(R.id.show_detail)
    public void showDetail() {
        multipleApiPresenter.showDetailSeries(editTextFullSeriesName.getText().toString());
    }
