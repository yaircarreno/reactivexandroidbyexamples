...
public class OrchestrationMenuAdapter extends RecyclerView.Adapter<OrchestrationMenuAdapter.ViewHolder> {

    private String[] mOptions;
    private PublishSubject<Integer> mViewClickEvent = PublishSubject.create();

    @Inject
    OrchestrationMenuAdapter() {
    }
    ...
    @Override
    public OrchestrationMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        final View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_home, parent, false);
        final ViewHolder viewHolder = new OrchestrationMenuAdapter.ViewHolder(itemView);
