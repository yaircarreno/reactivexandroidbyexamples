...
public class PaginationActivity extends BaseActivity implements PaginationMvpView {

    @Inject
    PaginationPresenter mPaginationPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPaginationPresenter.rxScrollEvents(RxRecyclerView.scrollEvents(mRecyclerView));

        mPaginationPresenter.loadCharacters();
